<template>
  <div class="about">
    <div class="container">
          <ButtonComponent href="https://jherogr.github.io/resume/" target="_blank" name="Resume" />
          ...
          <ButtonComponent href="/portfolio-website/blog" icon="bi bi-substack" name="Blog" />
